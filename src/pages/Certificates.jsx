            ...
            {certificates.map((cert, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative cursor-pointer bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl hover:shadow-[#FF2801]/30 transition-all duration-300 border-2 border-[#FF2801]/30 hover:border-[#FF2801]"
                >
                  <div className="absolute left-0 top-0 h-1 w-10 rounded-tl-xl bg-linear-to-r from-[#FF2801] to-[#434343] transition-all duration-300 group-hover:w-full group-hover:rounded-tr-xl z-10" />
                  ...
                  <div className="p-5 text-center bg-white relative z-10">
                    <h3 className="font-semibold text-slate-900 group-hover:text-[#434343] transition-colors">
                      {cert.title}
                    </h3>
                  </div>
                </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="sm:hidden flex items-center justify-between p-4 border-t border-slate-100 bg-white">
                ...
                <button
                  onClick={handleNext}
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#434343] text-white hover:bg-[#00a9c0]"
                >
