...
import { Award, Eye, X, ChevronLeft, ChevronRight, ZoomIn } from "lucide-react";
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 text-center bg-white relative z-10">
                    <h3 className="font-semibold text-slate-900 group-hover:text-[#00BED7] transition-colors">
                      {cert.title}
                    </h3>
                  </div>
                </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="sm:hidden flex items-center justify-between p-4 border-t border-slate-100 bg-white">
                ...
                <button
                  onClick={handleNext}
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#00BED7] text-white hover:bg-[#00a9c0]"
                >
